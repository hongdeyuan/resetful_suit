...
/*function uploadFileRequest(suit,urlPrefix){
	console.log(suit.find("#uploaderContainer input").attr("type"));
	suit.find("#uploaderContainer input").fileupload({
		    ...
		    dataType: 'json',
		    	...
		    	//console.log(urlPrefix+data.result.description);
		    	console.log(suit.find("uploaderContainer img").attr("src"));
